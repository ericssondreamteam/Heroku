...
(function () {
	...
	(function () {
		...
		function z(a, b, e, f) {
			...
			if (f.doFilter) {
				...
				if (!a || !a.valid) return e.push(b), 1;D = a.validAttributes;
				var B = a.validStyles;
				v = a.validClasses;
				var q = b.attributes,
					P = b.styles,
	...
	CKEDITOR.plugins.add("colorbutton", {
		...
		init: function (e) {
			function u(a, d, g, y, l) {
				var n = new CKEDITOR.style(m["colorButton_" + d + "Style"]),
				...
				e.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
					...
					refresh: function () {
						e.activeFilter.check(n) || this.setState(CKEDITOR.TRISTATE_DISABLED)
					},
					onOpen: function () {
						...
						if (c) {
							...
							!1 !== m.colorButton_enableAutomatic && this._.panel._.iframe.getFrameDocument().getById(q).setStyle("background-color", c);
							if (b = a && a.getRanges()[0]) {
								for (var a = new CKEDITOR.dom.walker(b), f = b.collapsed ? b.startContainer : a.next(), b = ""; f;) {
									f.type !== CKEDITOR.NODE_ELEMENT &&
										(f = f.getParent());
									f = r(f.getComputedStyle("back" == d ? "background-color" : "color"));
									b = b || f;
									if (b !== f) {
										b = "";
										break
								...
								"transparent" == b && (b = "");
								"fore" == d && (k.automaticTextColor = "#" + r(c));
								k.selectionColor = b ? "#" + b : "";
								a = b;
								b = p._.getItems();
								for (f = 0; f < b.count(); f++) {
									var g = b.getItem(f);
									g.removeAttribute("aria-selected");
									a && a == r(g.getAttribute("data-value")) && g.setAttribute("aria-selected", !0)
								}
							}
							return c
						}
			...
			function z(a, d, g, r) {
				a = [];
				var l = m.colorButton_colors.split(","),
					n = m.colorButton_colorsPerRow || 6,
					q = e.plugins.colordialog &&
					!1 !== m.colorButton_enableMore,
					k = l.length + (q ? 2 : 1),
					p = CKEDITOR.tools.addFunction(function (a, b) {
						function c(a) {
							var d = m["colorButton_" + b + "Style"];
				...
				!1 !== m.colorButton_enableAutomatic && a.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', h.auto, '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(', p, ",null,'", d, "');return false;\" href\x3d\"javascript:void('", h.auto, '\')" role\x3d"option" aria-posinset\x3d"1" aria-setsize\x3d"', k, '"\x3e\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e\x3ctr\x3e\x3ctd colspan\x3d"' + n + '" align\x3d"center"\x3e\x3cspan class\x3d"cke_colorbox" id\x3d"',
					g, '"\x3e\x3c/span\x3e', h.auto, "\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/a\x3e");
				a.push('\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e');
				for (g = 0; g < l.length; g++) {
					0 === g % n && a.push("\x3c/tr\x3e\x3ctr\x3e");
					var t = l[g].split("/"),
						b = t[0],
						c = t[1] || b;
					a.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', t[1] ? b : e.lang.colorbutton.colors[c] || c, '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(',
						p, ",'", c, "','", d, "'); return false;\" href\x3d\"javascript:void('", c, '\')" data-value\x3d"' + c + '" role\x3d"option" aria-posinset\x3d"', g + 2, '" aria-setsize\x3d"', k, '"\x3e\x3cspan class\x3d"cke_colorbox" style\x3d"background-color:#', c, '"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/td\x3e')
				}
				q && a.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d"' + n + '" align\x3d"center"\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', h.more, '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(',
					p, ",'?','", d, "');return false;\" href\x3d\"javascript:void('", h.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', k, '" aria-setsize\x3d"', k, '"\x3e', h.more, "\x3c/a\x3e\x3c/td\x3e");
				...
				if (void 0 === x || x) w.contentTransformations = [
					[{
						...
						left: function (a) {
							...
							return a.color && 1 === d.object.keys(a).length
						},
						right: function (a) {
					...
					function (e) {
						if (!e.data.preventFormatStripping) {
							...
							if (a.copyFormatting._isContextAllowed(f))
								for (h = 0; h < c.length; h++) f = c[h], g = d.createBookmark(), -1 === l(b.preservedElements, f.element) ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome ? c[h].removeFromRange(e.data.range, e.editor) : c[h].remove(e.editor) : u(f.element, e.data.styles) && b._removeStylesFromElementInRange(d, f.element), d.moveToBookmark(g)
						}
					});
				a.copyFormatting.on("applyFormatting",
					function (b) {
		...
		CKEDITOR.plugins.copyformatting = {
				...
				copyFormatting: {
					exec: function (a, b) {
						...
						if (this.state === CKEDITOR.TRISTATE_ON) return d.styles = null, d.sticky = !1, g.removeClass("cke_copyformatting_active"), h.removeClass("cke_copyformatting_disabled"), h.removeClass("cke_copyformatting_tableresize_cursor"),
							e._putScreenReaderMessage(a, "canceled"), e._detachPasteKeystrokeHandler(a), this.setState(CKEDITOR.TRISTATE_OFF);
				...
				applyFormatting: {
					...
					exec: function (a, b) {
						...
						f.sticky || (f.styles = null, g.removeClass("cke_copyformatting_active"), h.removeClass("cke_copyformatting_disabled"), h.removeClass("cke_copyformatting_tableresize_cursor"),
							e.setState(CKEDITOR.TRISTATE_OFF), c._detachPasteKeystrokeHandler(a));
			...
			_filterStyles: function (a) {
				var b = CKEDITOR.tools.isEmpty,
					...
					d, c;
				for (c = 0; c <
					a.length; c++) d = a[c]._.definition, -1 !== CKEDITOR.tools.indexOf(CKEDITOR.plugins.copyformatting.inlineBoundary, d.element) && (d.element = a[c].element = "span"), "span" === d.element && b(d.attributes) && b(d.styles) || e.push(a[c]);
				return e
			},
	...
	CKEDITOR.plugins.add("scayt", {
			...
			if (0 < c.length && "no_any_suggestions" !== c[0])
				if (d)
					for (d = 0; d < c.length; d++) {
						...
						for (d = 0; d < c.length; d++) l = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[d].replace(" ",
							"_"), a.addCommand(l, this.createCommand(CKEDITOR.plugins.scayt.suggestions[d], f, g)), a.addMenuItem(l, {
							label: c[d],
							command: l,
							group: "grayt_suggest",
							order: d + 1
		...
		menuGenerator: function (a, c) {
			...
			l ? (b = b.scayt, k = c.getAttribute(d.getScaytNodeAttributeName()), d.fire("getSuggestionsList", {
				lang: g,
				word: k
			}), e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, l)) : m && (b = b.grayt, e = c.getAttribute(d.getGraytNodeAttributeName()), d.getGraytNodeRuleAttributeName ? (k = c.getAttribute(d.getGraytNodeRuleAttributeName()), d.getProblemDescriptionText(e,
				k, g)) : d.getProblemDescriptionText(e, g), n = d.getProblemDescriptionText(e, k, g), b.grayt_problemdescription && n && (n = n.replace(/([.!?])\s/g, "$1\x3cbr\x3e"), b.grayt_problemdescription.label = n), d.fire("getGrammarSuggestionsList", {
				lang: g,
				phrase: e,
				rule: k
			}), e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, l));
			if (l && "off" == a.config.scayt_contextCommands) return e;
			for (var h in b) l && -1 == CKEDITOR.tools.indexOf(f, h.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || m && "grayt_problemdescription" !==
				h && -1 == CKEDITOR.tools.indexOf(f, h.replace("grayt_", "")) && "all" != a.config.scayt_contextCommands || (e[h] = "undefined" != typeof b[h].state ? b[h].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof b[h].verification || b[h].verification(a) || delete e[h], a.addCommand(h, {
					exec: b[h].exec
				}), a.addMenuItem(h, {
		...
		createCommand: function (a, c, d) {
			return {
				exec: function (b) {
					...
					"startGrammarCheck" ===
					d && b.removeMarkupInSelectionNode({
						grammarOnly: !0
					});
					b.fire(d)
				}
	...
	CKEDITOR.plugins.scayt = {
		...
		reloadMarkup: function (a) {
			var c;
			a && (c = a.getScaytLangList(), a.reloadMarkup ? a.reloadMarkup() : (this.alarmCompatibilityMessage(),
		...
		createScayt: function (a) {
			...
			this.loadScaytLibrary(a, function (a) {
				...
				if (f) {
					...
					"boolean" === typeof a.config.scayt_ignoreWordsWithMixedCases && (f["ignore-words-with-mixed-cases"] =
	...
	(function () {
		...
		function B(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				...
				g = new CKEDITOR.dom.element(e[a +
		...
		function y(d) {
			...
			for (d = a.length; m < d; m++)
				for (var n =
						0, p = a[m].length; n < p; n++) void 0 === k && a[m][n] == e.$ && (k = n), a[m][n] == g.$ && (h = n);
			for (m = k; m <= h; m++)
	...
	(function () {
		...
		function z(a, b) {
			...
			m > l && (c = m, m = l, l = c);
			for (c = f; c <= k; c++)
				for (f = m; f <= l; f++) d = new CKEDITOR.dom.element(e[c][f]),
					d.$ && !d.getCustomData("selected_cell") && (h.push(d), CKEDITOR.dom.element.setMarker(g, d, "selected_cell", !0));
			CKEDITOR.dom.element.clearAllMarkers(g);
			return h
		}
		...
		function L(a, b, c) {
			...
			b = b.is("table") ? null : b;
			var e;
			(e = n.active && !n.first) && !(e = b) && (e = a.getSelection().getRanges(), e = 1 < d.length || e[0] && !e[0].collapsed ? !0 : !1);
			if (e) n.first = b || d[0], n.dirty = b ? !1 : 1 !== d.length;
			else if (n.active && b && n.first.getAscendant("table").equals(b.getAscendant("table"))) {
				d = z(n.first, b);
				if (!n.dirty && 1 === d.length && !D(c.data.getTarget())) return A(a, "mouseup" === c.name);
				n.dirty = !0;
				n.last = b;
				t(a, d)
			}
		...
		function w(a) {
			function b(a, b) {
				return a && b ? a.equals(b) || a.contains(b) || b.contains(a) || a.getCommonAncestor(b).is(m) : !1
			}
			...
			if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				...
				h && h.hasAttribute("data-cke-tableselection-ignored") || (d(a, f, k, h) && A(e, !0), !n.active && "mousedown" === a.name && CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && h && (n = {
					active: !0
				}, CKEDITOR.document.on("mouseup", w, null, {
					editor: e
				})), (g || h) && L(e, g || h, a), "mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && (c(a.data.getTarget()) || b(k, h)) && K(e), n = {
					active: !1
		...
		function O(a, b) {
			...
			var d = a.getSelection(),
				...
				l, x, p, n;
			f.getById("cke_table_copybin") || (l = f.createElement(m), x = f.createElement(m),
				x.setAttributes({
					...
					height: "1px",
					overflow: "hidden"
				}), l.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), l.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), x.append(l), a.editable().append(x), n = a.on("selectionChange", c, null, null, 0), g && (p = h.scrollTop), k.selectNodeContents(l), k.select(), g && (h.scrollTop = p), setTimeout(function () {
					x.remove();
					d.selectBookmarks(e);
					n.removeListener();
					a.fire("unlockSnapshot");
		...
		function E(a) {
			...
			c.isInTable() && (c.getRanges()[0]._getTableElement({
				table: 1
			}).hasAttribute("data-cke-tableselection-ignored") || O(b, "cut" === a.name))
		}
		...
		q.prototype.insertRow = function (a, b, c) {
			...
			for (var d = this.cells.first.$.cellIndex,
					e = this.cells.last.$.cellIndex, f = c ? [] : this.cells.all, k, h = 0; h < a; h++) k = F(c ? this.cells.all : f, b), k = CKEDITOR.tools.array.filter(k.find("td, th").toArray(), function (a) {
				return c ? !0 : a.$.cellIndex >= d && a.$.cellIndex <= e
			}), f = b ? k.concat(f) : f.concat(k);
		...
		q.prototype.insertColumn = function (a) {
			...
			for (var c = this.cells, d = c.all, e = r(c.first), f = r(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(G(d), b));
		...
		var H = {
			onPaste: function (a) {
				...
				var d = a.editor,
					e = d.getSelection(),
					f = e.getRanges(),
					f = f.length && f[0]._getTableElement({
						table: 1
					});
				if (!f || !f.hasAttribute("data-cke-tableselection-ignored")) {
					var k = v(e),
						f = this.findTableInPastedContent(d, a.data.dataValue),
						h = e.isInTable(!0) && this.isBoundarySelection(e),
						g, m;
					!k.length || 1 === k.length && !I(e.getRanges()[0]) && !h || h && !f || (k = k[0].getAscendant("table"), g = new q(v(e, k)), d.once("afterPaste", function () {
						var a;
						if (m) {
							a = new CKEDITOR.dom.element(m[0][0]);
							var b = m[m.length - 1];
							a = z(a, new CKEDITOR.dom.element(b[b.length - 1]))
						} else a = g.cells.all;
						t(d, a)
					}), f ? (a.stop(),
						h ? (g.insertRow(1, 1 === h, !0), e.selectElement(g.rows.first)) : (g.emptyCells(), t(d, g.cells.all)), a = g.getTableMap(), m = CKEDITOR.tools.buildTableMap(f), g.insertRow(m.length - a.length), g.insertColumn(b(m) - b(a)), a = g.getTableMap(), this.pasteTable(g, a, m), d.fire("saveSnapshot"), setTimeout(function () {
							d.fire("afterPaste")
						}, 0)) : (c(g.cells.first), d.once("afterPaste", function () {
						d.fire("lockSnapshot");
						g.emptyCells(g.cells.all.slice(1));
						t(d, g.cells.all);
						d.fire("unlockSnapshot")
					})))
				}
			...
			pasteTable: function (a, b, c) {
				...
				for (m = 0; m < c.length; m++)
					for (h = new CKEDITOR.dom.element(f.$.rows[a.rows.first.$.rowIndex + m]), l = 0; l < c[m].length; l++)
						if (g = new CKEDITOR.dom.element(c[m][l]), d = b[m] && b[m][l] ? new CKEDITOR.dom.element(b[m][l]) : null, g && !g.getCustomData("processed")) {
							if (d && d.getParent()) g.replace(d);
							else if (0 === l || c[m][l - 1])(d = 0 !== l ? new CKEDITOR.dom.element(c[m][l - 1]) : null) && h.equals(d.getParent()) ? g.insertAfter(d) : 0 < e ? h.$.cells[e] ? g.insertAfter(new CKEDITOR.dom.element(h.$.cells[e])) : h.append(g) : h.append(g, !0);
							CKEDITOR.dom.element.setMarker(k,
								g, "processed", !0)
						} else g.getCustomData("processed") && d && d.remove();
				CKEDITOR.dom.element.clearAllMarkers(k)
			}
		};
			...
			keyboardIntegration: function (a) {
				...
				c.attachListener(c, "keydown", function (a) {
						function c(b, e) {
							...
							var f = a.createRange(),
								l = CKEDITOR.dom.range.mergeRanges(e);
							CKEDITOR.tools.array.forEach(l, function (a) {
								a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
							});
							var n = l[0].getBoundaryNodes(),
								p = n.startNode,
								n = n.endNode;
							if (p && p.is && p.is(k)) {
								for (var q = p.getAscendant("table", !0), u = p.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q), r = !1, t = function (a) {
										return !p.contains(a) && a.is && a.is("td", "th")
									}; u && !t(u);) u = u.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
								!u && n && n.is && !n.is("table") && n.getNext() && (u = n.getNext().findOne("td, th"), r = !0);
								if (u) f["moveToElementEdit" +
									(r ? "Start" : "End")](u);
								else f.setStartBefore(p.getAscendant("table", !0)), f.collapse(!0);
								l[0].deleteContents();
								return [f]
							}
						...
						return function (h) {
							var g = h.data.getKey(),
								k = h.data.getKeystroke(),
								l, n = 37 === g || 38 == g,
								p, q, r;
							if (f[g] && !a.readOnly && (l = a.getSelection()) && l.isInTable() && l.isFake) {
								p = l.getRanges();
								q = p[0]._getTableElement();
								r = p[p.length -
									1]._getTableElement();
								if (13 !== g || a.plugins.enterkey) h.data.preventDefault(), h.cancel();
								if (36 < g && 41 > g) p[0].moveToElementEditablePosition(n ? q : r, !n), l.selectRanges([p[0]]);
								else if (13 !== g || 13 === k || k === CKEDITOR.SHIFT + 13) {
									for (h = 0; h < p.length; h++) b(p[h]);
									(h = c(q, p)) ? p = h: p[0].moveToElementEditablePosition(q);
									l.selectRanges(p);
									13 === g && a.plugins.enterkey ? (a.fire("lockSnapshot"), 13 === k ? a.execCommand("enter") : a.execCommand("shiftEnter"), a.fire("unlockSnapshot"), a.fire("saveSnapshot")) : 13 !== g && a.fire("saveSnapshot")
								}
							}
						}
					}(a),
				...
				c.attachListener(c, "keypress", function (c) {
					var e = a.getSelection(),
						...
						k;
					if (!a.readOnly && e && e.isInTable() && e.isFake && f && !(c.data.getKeystroke() & CKEDITOR.CTRL)) {
						c = e.getRanges();
						...
						f && (c[0].moveToElementEditablePosition(f), e.selectRanges([c[0]]))
					}
				}, null, null, -1)
			}
		};
